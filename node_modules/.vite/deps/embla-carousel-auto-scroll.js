...
function AutoScroll(userOptions = {}) {
	...
	function init(emblaApiInstance, optionsHandler) {
		...
		options = optionsAtMedia(mergeOptions(mergeOptions(defaultOptions, AutoScroll.globalOptions), userOptions));
		...
		if (options.stopOnFocusIn) emblaApi.on("slideFocusStart", stopAutoScroll);
		if (options.stopOnFocusIn && !options.stopOnInteraction) eventStore.add(emblaApi.containerNode(), "focusout", startAutoScroll);
	...
	function play(startDelayOverride) {
		if (typeof startDelayOverride !== "undefined") startDelay = startDelayOverride;
		startAutoScroll();
	}
	function stop() {
